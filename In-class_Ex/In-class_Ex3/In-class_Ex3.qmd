...
> `choicealpha()` is for us to balance 2 matrice.
>
...
>
> 2.  2nd graph based on normalisation values -\> if we find that our data is highly skewed
>
...
>
> Compare a few alpha values to see how the map changes

> Interpretation -\> see heatmaply OR boxplot (summary stats)
