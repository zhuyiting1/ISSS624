...
This document is a replicate of the Hands-on Exercise 4, wit additional explanatory notes. Notes are indicated in the following format:
...
>
> We compare the AICc values: 42,967.14 vs 42,263.61 -\> select the model which gives the [smallest]{.underline} AICc value.
>
